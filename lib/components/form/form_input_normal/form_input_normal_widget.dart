...
import 'form_input_normal_model.dart';
export 'form_input_normal_model.dart';

class FormInputNormalWidget extends StatefulWidget {
  const FormInputNormalWidget({
    super.key,
    required this.title,
  ...
  @override
  State<FormInputNormalWidget> createState() => _FormInputNormalWidgetState();
}

class _FormInputNormalWidgetState extends State<FormInputNormalWidget> {
  late FormInputNormalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FormInputNormalModel());
        ...
        child: Form(
          ...
          child: Builder(
            builder: (context) {
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: FlutterFlowDropDown<String>(
                        ...
                        options: widget.data!.map((e) => e.toString()).toList(),
                        onChanged: (val) async {
              ...
              } else if ((widget.type == 'array') && (widget.isMulti == true)) {
                return Align(
                  alignment: AlignmentDirectional(-1.0, 0.0),
                  child: Column(
                    mainAxisSize: MainAxisSize.max,
